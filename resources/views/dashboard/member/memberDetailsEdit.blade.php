...
<div class="container mt-5">
        ...
        <div class="tab-content" id="crmTabsContent">
            <div class="tab-pane fade show active" id="personal-info" role="tabpanel">
                <form id="multiStepsForm" method="POST" action="{{ route('members-details-update',['id'=>$member->id]) }}">
                    @csrf
                    <div class="mb-3">
                        <label for="memberName" class="form-label">Member Name</label>
                        <input type="text" class="form-control" id="memberName" name="member_name" placeholder="Full member name" value="{{ $member->member_name }}">
                    </div>
                    <div class="mb-3">
            ...
            <div class="tab-pane fade" id="beneficiaries" role="tabpanel">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="beneficiaryName" name="beneficiary_name" placeholder="List of beneficiaries" value="{{ $member->beneficiary_name }}">
                    </div>
                    <div class="mb-3">
                        <label for="beneficiaryRelationship" class="form-label">Beneficiary Relationship</label>
                        <input type="text" class="form-control" id="beneficiaryRelationship" name="beneficiary_relationship" placeholder="Relationship to member" value="{{ $member->beneficiary_relationship }}">
                    </div>
                    <div class="mb-3">
                        <label for="beneficiaryPercentage" class="form-label">Beneficiary Percentage</label>
                        <input type="number" class="form-control" id="beneficiaryPercentage" name="beneficiary_percentage" placeholder="Percentage allocation" value="{{ $member->beneficiary_percentage }}">
                    </div>
                    <div class="mb-3">
            ...
            <div class="tab-pane fade" id="contributions" role="tabpanel">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="contributions_received" name="contributions_received" rows="4" value="" placeholder='Enter contributions in JSON format, e.g., [{"amount": 1000, "date": "2023-01-01"}]'>{{ $member->contributions_received }}</textarea>
                    </div>
            </div>
