        ...
        <div class="col-md-8">
            <div class="">
                <div class="card-body text-center p-5">
                    ...
                    <p class="my-5">
                        It will take you approximately <strong>20 minutes</strong> to complete this application.
                    ...
                    <a href="{{ route('members-oasis-create') }}" class="btn btn-primary mt-4 px-4 py-2">
                        Start Application 🚀
                    </a>
                </div>
            </div>
