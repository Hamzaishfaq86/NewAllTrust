            ...
            <div class="">
                <div class="card-body text-center p-5">
                    ...
                    <p class="text-muted mt-3">
                        It will take you approximately <strong>30-40 minutes</strong> to complete this application.
                        Please make sure that you have the following information ready:
                    </p>
                    <ul class="list-unstyled mt-3">
                        <li>🔹 <strong>Individual Member and Scheme Information</strong></li>
                    ...
                    <a href="{{ route('fpt-create') }}" class="btn btn-primary mt-4 px-4 py-2 font-weight-bold">
                        Start Application 🚀
                    </a>
                </div>
            </div>
