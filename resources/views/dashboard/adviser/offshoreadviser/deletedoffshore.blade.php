        ...
        <div class="card">
            <div class="card-datatable table-responsive">
                <table class="dt-responsive table">
                    ...
                    <tbody>
                    @foreach($deletedAdvisers as $index => $adviser)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{ route('offshore-restore', ['id' => $adviser->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to restore this adviser?');">
                                            @csrf
