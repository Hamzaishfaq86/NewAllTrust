 ...
 <div class="container mt-5">
        ...
        <div class="tab-content" id="crmTabsContent">
            <div class="tab-pane fade show active" id="personal-info" role="tabpanel">
                <form method="POST" action="{{ route('member-detail-store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="memberName" class="form-label">Member Name</label>
                        <input type="text" class="form-control" id="memberName" name="member_name" placeholder="Full member name">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nationalInsurance" name="national_insurance_number" placeholder="National Insurance Number">
                    </div>
                    <div class="mb-3">
                        <label for="taxInformation" class="form-label">Tax Information Number</label>
                        <input type="text" class="form-control" id="taxInformation" name="tax_information_number" placeholder="Tax ID Number">
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Address</label>
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Member address"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Member email address">
                    </div>
            </div>
            <div class="tab-pane fade" id="beneficiaries" role="tabpanel">
                    <div class="mb-3">
                        <label for="beneficiaryName" class="form-label">Beneficiary Name</label>
                        <input type="text" class="form-control" id="beneficiaryName" name="beneficiary_name" placeholder="List of beneficiaries">
                    </div>
                    <div class="mb-3">
                        <label for="beneficiaryRelationship" class="form-label">Beneficiary Relationship</label>
                        <input type="text" class="form-control" id="beneficiaryRelationship" name="beneficiary_relationship" placeholder="Relationship to member">
                    </div>
                    <div class="mb-3">
                        <label for="beneficiaryPercentage" class="form-label">Beneficiary Percentage</label>
                        <input type="number" class="form-control" id="beneficiaryPercentage" name="beneficiary_percentage" placeholder="Percentage allocation">
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-success mt-3">Add Beneficiaries</button>
                    </div>
            </div>
            ...
            <div class="tab-pane fade" id="adviser-fees" role="tabpanel">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="adviserFeeDetails" name="adviser_fee_details" rows="3" placeholder="Adviser Fee Agreement Details"></textarea>
                    </div>
            </div>
            <div class="tab-pane fade" id="transfers" role="tabpanel">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="transferRequestDate" name="transfer_request_received_date">
                    </div>
                    <div class="mb-3">
                        <label for="cedingSchemeName" class="form-label">Ceding Scheme Name</label>
                        <input type="text" class="form-control" id="cedingSchemeName" name="ceding_scheme_name" placeholder="Name of ceding scheme">
                    </div>
                    <div class="mb-3">
                        <label for="cedingSchemeReference" class="form-label">Ceding Scheme Reference</label>
                        <input type="text" class="form-control" id="cedingSchemeReference" name="ceding_scheme_reference" placeholder="Reference for the scheme">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="transferAmount" name="transfer_amount" placeholder="Amount transferred">
                    </div>
                    <div class="mb-3">
                        <label for="transferCompletionDate" class="form-label">Transfer Completion Date</label>
                        <input type="date" class="form-control" id="transferCompletionDate" name="transfer_completion_date">
                    </div>
                    <div class="mb-3">
                        <label for="crystallisationStatus" class="form-label">Crystallisation Status</label>
                        <input type="text" class="form-control" id="crystallisationStatus" name="crystallisation_status">
                    </div>
            </div>
            ...
            <div class="tab-pane fade" id="contributions" role="tabpanel">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="mpaa_trigger_date" name="mpaa_trigger_date">
                    </div>
                    <div class="mb-3">
                        <label for="contributions_received" class="form-label">Contributions Received</label>
                        <textarea class="form-control" id="contributions_received" name="contributions_received" rows="4" placeholder='Enter contributions in JSON format, e.g., [{"amount": 1000, "date": "2023-01-01"}]'></textarea>
                    </div>
            </div>
            <div class="tab-pane fade" id="bank-accounts" role="tabpanel">
                    <div class="mb-3">
                        <label for="bank_provider" class="form-label">Bank Provider</label>
                        <input type="text" class="form-control" id="bank_provider" name="bank_provider" placeholder="Enter bank provider"  >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="sort_code" name="sort_code" placeholder="Enter sort code"  title="Sort code must be 6 digits"  >
                    </div>
                    <div class="mb-3">
                        <label for="account_number" class="form-label">Account Number</label>
                        <input type="text" class="form-control" id="account_number" name="account_number" placeholder="Enter account number"  title="Account number must be 8 digits"  >
                    </div>
                    <div class="mb-3">
                        <label for="account_opened_date" class="form-label">Account Opened Date</label>
                        <input type="date" class="form-control" id="account_opened_date" name="account_opened_date"  >
                    </div>
            </div>
            ...
            <div class="tab-pane fade" id="assets" role="tabpanel">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="holding_type" name="holding_type" placeholder="Enter holding type (e.g., Property, Platform, Cash)"  >
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter asset description"  ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="provider" class="form-label">Provider</label>
                        <input type="text" class="form-control" id="provider" name="provider" placeholder="Enter provider name"  >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="latest_value" name="latest_value" placeholder="Enter latest value (e.g., 1000.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="latest_value_date" class="form-label">Latest Value Date</label>
                        <input type="date" class="form-control" id="latest_value_date" name="latest_value_date"  >
                    </div>
            </div>
            ...
            <div class="tab-pane fade" id="benefit-events" role="tabpanel">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="protection_held" name="protection_held" placeholder="Enter protection type or 'N/A'"  >
                    </div>
                    <div class="mb-3">
                        <label for="protection_details" class="form-label">Protection Details</label>
                        <textarea class="form-control" id="protection_details" name="protection_details" rows="3" placeholder="Enter details about protection"  ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="lta_pre_06_04_24" class="form-label">Lifetime Allowance (Pre 06/04/24)</label>
                        <input type="number" class="form-control" id="lta_pre_06_04_24" name="lta_pre_06_04_24" placeholder="Enter Lifetime Allowance before 06/04/24 (e.g., 50000.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="converted_lump_sum_allowance" class="form-label">Converted Lump Sum Allowance</label>
                        <input type="number" class="form-control" id="converted_lump_sum_allowance" name="converted_lump_sum_allowance" placeholder="Enter converted lump sum allowance (e.g., 20000.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="total_lsa_consumed" class="form-label">Total LSA Consumed</label>
                        <input type="number" class="form-control" id="total_lsa_consumed" name="total_lsa_consumed" placeholder="Enter total lump sum allowance consumed (e.g., 10000.00)" min="0"  >
                    </div>
            </div>
            ...
            <div class="tab-pane fade" id="crystallisations" role="tabpanel">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="crystallisation_date" name="crystallisation_date"  >
                    </div>
                    <div class="mb-3">
                        <label for="crystallisation_type" class="form-label">Crystallisation Type</label>
                        <input type="text" class="form-control" id="crystallisation_type" name="crystallisation_type" placeholder="Enter crystallisation type (e.g., Lump Sum, Drawdown)" maxlength="255" >
                    </div>
                    <div class="mb-3">
                        <label for="amount_crystallised" class="form-label">Amount Crystallised</label>
                        <input type="number" class="form-control" id="amount_crystallised" name="amount_crystallised" placeholder="Enter amount crystallised (e.g., 50000.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="tax_free_lump_sum" class="form-label">Tax-Free Lump Sum</label>
                        <input type="number" class="form-control" id="tax_free_lump_sum" name="tax_free_lump_sum" placeholder="Enter tax-free lump sum (e.g., 12500.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="sla_consumed_pre_06_04_24" class="form-label">SLA Consumed (Pre 06/04/24)</label>
                        <input type="number" class="form-control" id="sla_consumed_pre_06_04_24" name="sla_consumed_pre_06_04_24" placeholder="Enter SLA % consumed before 06/04/24 (e.g., 25.00)" min="0" max="100"  >
                    </div>         
            </div>
            ...
            <div class="tab-pane fade" id="pension-payments" role="tabpanel">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="net_payment" name="net_payment" placeholder="Enter net payment amount (e.g., 1200.50)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="paye" class="form-label">PAYE Amount</label>
                        <input type="number" class="form-control" id="paye" name="paye" placeholder="Enter PAYE amount (e.g., 300.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="net_in_tax_year" class="form-label">Net in Tax Year</label>
                        <input type="number" class="form-control" id="net_in_tax_year" name="net_in_tax_year" placeholder="Enter net payment in the tax year (e.g., 10000.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="paye_in_tax_year" class="form-label">PAYE in Tax Year</label>
                        <input type="number" class="form-control" id="paye_in_tax_year" name="paye_in_tax_year" placeholder="Enter PAYE amount in the tax year (e.g., 2500.00)" min="0"  >
                    </div>
                    <div class="mb-3">
                        <label for="tax_code" class="form-label">Tax Code</label>
                        <input type="text" class="form-control" id="tax_code" name="tax_code" placeholder="Enter tax code applied (e.g., 1250L)" maxlength="10"  >
                    </div>
                    <div class="mb-3">
