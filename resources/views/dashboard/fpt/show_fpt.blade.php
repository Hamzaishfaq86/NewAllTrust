                                        ...
                                        <div class="row g-6">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="scheme_name" name="scheme_name" value="{{$fpt->scheme_name}}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="contact_name" class="form-label">Contact Name</label>
                                                    <input type="text" class="form-control" id="contact_name" name="contact_name"  value="{{$fpt->contact_name}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="company_name" name="company_name"  value="{{$fpt->company_name}}" readonly>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="country" name="country"  value="{{$fpt->country}}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="post_code" class="form-label">Post Code</label>
                                                    <input type="text" class="form-control" id="post_code" name="post_code"value="{{$fpt->post_code}}" readonly>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="dial_code" name="dial_code"
                                                               placeholder="Dial Code"value="{{$fpt->dial_code}}" readonly>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                                                               placeholder="Phone Number" value="{{$fpt->phone_number}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" value="{{$fpt->email}}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="regulated_by" class="form-label">Regulated by</label>
                                                    <input type="text" class="form-control" id="regulated_by" name="regulated_by" value="{{$fpt->regulated_by}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="auth_number" name="auth_number"value="{{$fpt->auth_number}}" readonly>
                                                </div>
                                                <div class="col-md-6">

                                                    <label for="initial_fee" class="form-label">Initial fee for arranging the scheme: £</label>

                                                    <input type="text" class="form-control" id="initial_fee" name="initial_fee" value="{{$fpt->initial_fee}}" readonly>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="scheme_establishment"
                                                       name="scheme_establishment"  {{ $fpt->scheme_establishment ? 'checked' : '' }} readonly>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <input type="text" class="form-control" id="annual_fee" name="annual_fee" value="{{$fpt->annual_fee}}" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <div class="mb-2">
                                                    <input class="form-check-input" type="checkbox" id="scheme_anniversary"
                                                           name="scheme_anniversary" {{$fpt->scheme_anniversary ? 'checked' : '' }} readonly>
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-md-4">
                                                        <input class="form-check-input" type="checkbox" id="date_option2" name="date_option2"
                                                               {{$fpt->date_option2 ? 'checked' : '' }} readonly>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-input">
                                                    <input type="checkbox" id="percentage_checkbox" name="percentage_checkbox"
                                                           {{$fpt->percentage_checkbox ? 'checked' : '' }} >
                                                    ...
                                                    <input type="text" class="form-control" id="percentage" name="percentage" placeholder="%"
                                                           aria-label="Percentage"  value="{{$fpt->percentage}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="custom-input">
                                                    <input type="checkbox" id="specific_investments_checkbox" name="specific_investments_checkbox"
                                                          {{$fpt->specific_investments_checkbox ? 'checked' : '' }} readonly>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="initial_fee_amount1" placeholder="£" value="{{$fpt->initial_fee_amount1}}" readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="initial_fee_percentage1" placeholder="%"
                                                               value="{{$fpt->initial_fee_percentage1}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="mb-2">
                                                    <input type="checkbox" id="scheme_establishment_alternative1"
                                                           name="scheme_establishment_alternative1"  {{$fpt->scheme_establishment_alternative1 ? 'checked' : '' }}>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-input mt-2">
                                                    <input type="checkbox" id="scheme_anniversary_alternative1"
                                                           name="scheme_anniversary_alternative1"  {{$fpt->scheme_anniversary_alternative1 ? 'checked' : '' }} >
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="amount-section row">
                                                    <div class="inline-checkbox col-md-6">
                                                        <input type="checkbox" id="amount_checkbox" name="transfer_amount_checkbox1"  {{$fpt->transfer_amount_checkbox1 ? 'checked' : '' }} >
                                                ...
                                                <div class="percentage-section row mt-2">
                                                    <div class="inline-checkbox col-md-6">
                                                        <input type="checkbox" id="percentage_checkbox_transfer1"
                                                               name="percentage_checkbox_transfer1"  {{$fpt->percentage_checkbox_transfer1 ? 'checked' : '' }} >
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-input">
                                                    <div class="inline-checkbox">
                                                        <input type="radio" id="future_terms_yes" name="future_terms1"  {{$fpt->future_terms1 ? 'checked' : '' }} >
                                                        <label for="future_terms_yes">Yes</label>
                                                    </div>
                                                    <div class="inline-checkbox">
                                                        <input type="radio" id="future_terms_no" name="future_terms1" {{$fpt->future_terms1 ? 'checked' : '' }} >
                                            ...
                                            <div class="mb-3">
                                                <div class="mb-2">
                                                    <input type="checkbox" id="scheme_establishment_alternative2"
                                                           name="scheme_establishment_alternative2" {{$fpt->scheme_establishment_alternative2 ? 'checked' : '' }} >
                                                        ...
                                                        <div id="multiFormStepper" class="form-stepper border-none shadow-none mt-5">
                                                            ...
                                                            <div id="stepSecond" class="step-content" style="display: none;">
                                                                ...
                                                                <div class="row g-6">
                                                                    ...
                                                                    <div class="form-group mt-2">
                                                                        <label for="annual_fee">Annual Fee</label>
                                                                        <input type="text" class="form-control" id="annual_fee" name="adviser_agrement_annual_fee11" placeholder="Enter Annual Fee" value="{{ $fpt['adviser_agrement_annual_fee11'] ?? '' }}">
                                                                    </div>
