    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
        <div class="authentication-inner row">
            ...
            <div class="step active" data-step="0">
                ...
                <div class="step-subtitle">Applications</div>
            </div>
            <div class="arrow">→</div>
            <div class="step disabled" data-step="1">
                <div class="step-icon"><i class="fas fa-user"></i></div>
                <div class="step-subtitle">Installation Questionnaire</div>
            </div>
            <div class="arrow">→</div>
                            ...
                            <form id="multiStepsForm" method="POST" enctype="multipart/form-data" action="{{ route('fpt-store') }}">
                                ...
                                <div id="adviserDetails" class="content" style="display: block;">
                                    ...
                                    <div class="row g-6">
                                        ...
                                        <!--        <select class="form-control" name="user_id" id="title" readonly>-->
                                        <!--          @foreach($fpts as $mem)-->
...
{{--                                                                            </button>--}}
    ...
    btn.addEventListener('click', (event) => {
        event.preventDefault(); // Prevent the default behavior (e.g., form submission or page reload)
