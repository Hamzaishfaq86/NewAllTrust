                    ...
                    <tbody>
                        @foreach($pendingMembers as $index => $member)
                            ...
                            <tr>
                                ...
                                <td>{{ $user->role ?? 'No Role Assigned'  ?? 'No Role Assigned' }}</td> <!-- Safely access the user's role -->
                                <td>{{ $member->country }}</td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-sm dropdown-toggle {{ $member->status === 'active' ? 'bg-success text-white' : 'bg-warning text-white' }}" type="button" id="statusDropdown{{ $member->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item waves-effect" href="{{ route('comment.index', ['id' => $member->id]) }}"><i class="ti ti-message-2"></i> message</a>
        ...
        <div class="card my-5">
            ...
            <div class="card-datatable table-responsive">
                <table class="dt-responsive table">
                    ...
                    <tbody>
                      @foreach($fptPendingMembers as $index => $member)
                            @php
                                // Fetch the user based on the member's role field
